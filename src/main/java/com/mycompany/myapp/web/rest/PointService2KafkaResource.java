...
public class PointService2KafkaResource {
    ...
    private final Logger log = LoggerFactory.getLogger(PointService2KafkaResource.class);
    ...
    public PointService2KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
